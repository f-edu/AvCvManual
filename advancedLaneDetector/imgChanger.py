...
stream = cv.VideoCapture("test_videos/test1.avi") #6 7 8
...
#RoadTest
cropArea = [0, 100, 640, 350] #[from left, from up, to right, to down ]
# cropArea = [0, 124, 637, 298]
sensorsNumber = 12
sensorsWidth = 150
#6L
line1LStart = np.array([100, 80])
line1LEnd = np.array([0, 250])
#6R
line1RStart = np.array([540, 80])
line1REnd = np.array([640, 250])
#7L
